  ...
  tests = [
    {
      ...
      fn: async (runtime: any) => {
        ...
        if (character.name !== 'NeuroscienceCommunity') {
          throw new Error(`Expected character name to be 'NeuroscienceCommunity', got '${character.name}'`);
        }
...

    {
       ...
       *
       * This tests the full AI pipeline: understanding â†’ decision making â†’ action execution
       */

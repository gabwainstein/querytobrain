...
**Abbreviations:** ASD = autism spectrum disorder; DLPFC = dorsolateral prefrontal cortex; DMN = default mode network; GAD = generalized anxiety disorder; FAD = fear-related anxiety disorders; IAPS = International Affective Picture System; IBMA = image-based meta-analysis; IBC = Individual Brain Charting; MDD = major depressive disorder; NPS = Neurologic Pain Signature; ToM = theory of mind; VBM = voxel-based morphometry; WM = working memory (in cognitive contexts) or white matter (in tract/atlas contexts).
...
**High priority (subject-level, many maps):** 1952, 6618, 2138, 4343, 16284, 503, 3324, 16266

**Medium priority:** 426, 445, 507, 2503, 4804, 504, 13042, 13705, 2108, 4683, 3887, 1516, 13474, 20510, 11646, 437, 12992, 19012, 6825, 1620

~~**Check (may already be group):** 503~~ → **Added to AVERAGE_FIRST**: 182 subjects × 30 IAPS images → **1 map**: IAPS negative vs neutral (PINES)
...
| **18197** | 2 | Peraza IBMA (image-based meta-analysis) — WM, motor, emotion |
| **844** | 2 | Working memory meta-analysis |
| **833** | 2 | Motor learning meta-analysis |
| **830** | 2 | Vestibular cortex meta-analysis |
| **825** | 2 | DLPFC (dorsolateral prefrontal cortex) co-activation parcellation |
...
| **3884** | 2 | MDD (major depressive disorder) reward meta-analysis |
...
| **6262** | 2 | DMN (default mode network) parcellation meta-analysis |
| **7793** | 2 | Social reward meta-analysis |
| **8448** | 2 | Executive function networks (166 SPMs) |
| **11343** | 2 | GAD/FAD/MDD (generalized anxiety, fear-related anxiety, major depression) VBM meta-analysis |
...
| **2884** | 3 | Anxious working memory (WM) (group T-maps) |
...
| **12480** | 3 | DLPFC (dorsolateral prefrontal cortex) stimulation and reward |
...
| **7114** | 4 | Child white matter (WM) tract atlas |
...
| **7756–7761** | 4 | White matter (WM) function atlas (6 parts) |
...
| **6618** | 1 | IBC (Individual Brain Charting) 2nd release — 13 subjects × 205 contrasts; individual SPMs | **High** |
| **2138** | 1 | IBC (Individual Brain Charting) 1st release — 12 subjects × 59 contrasts; unsmoothed SPMs | **High** |
...
| **445** | 3 | Why/How theory-of-mind (ToM) validation — 3 fMRI studies | Medium |
...
| **503** | 3 | PINES/IAPS — N=182 × 30 images; **output**: 1 contrast (negative vs neutral) | High |
| **3324** | 1 | Kragel 2018 pain/cog/emotion — 15 subjects × 18 studies; **output**: 18 maps (Study 1 … Study 18) | **High** |
| **16266** | 3 | Emotion regulation system ID — PIP/AHAB Subject0001 LookNeg Beta → **output**: LookNeg, LookNeu, RegNeg, etc. | **High** |
| **16284** | 3 | IAPS emotional valence — **Individual betas; N=56** | **High** |
| **504** | 3 | Pain comparison — Neurologic Pain Signature (NPS); multiple intensity levels | Medium |
| **13042** | 3 | Language and working memory (WM) in epilepsy | Medium |
| **13705** | 3 | (Tier 3 language) | Medium |
| **2108** | 3 | (Tier 3) | Medium |
| **4683** | 3 | (Tier 3) | Medium |
| **3887** | 3 | (Tier 3) | Medium |
| **1516** | 3 | (Tier 3) | Medium |
| **13474** | 4 | Tensorial ICA for MDD (major depressive disorder) | Medium |
| **20510** | 4 | Lesions causing psychosis | Medium |
| **11646** | 4 | ASD (autism spectrum disorder) emotional egocentricity (21 ASD vs 21 controls) | Medium |
